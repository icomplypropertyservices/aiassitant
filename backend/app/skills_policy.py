...
_ID_CATEGORY: dict[str, str] = {
    ...
    "add_project": "core",
    "list_projects": "core",
    "sort_late_projects": "core",
    "sort_late_work": "core",
    "unstick_projects": "core",
    "create_pattern": "core",
    "save_pattern": "core",
    "list_patterns": "core",
    "get_pattern": "core",
    ...
    "list_agent_custom_fields": "meta",
    "get_agent_custom_field": "meta",
    "set_agent_custom_field": "meta",
    "delete_agent_custom_field": "meta",
    "set_agent_custom_fields": "meta",
    # crm
    "list_customers": "crm",
    "get_customer": "crm",
    "create_customer": "crm",
...
_PACK_KEYWORDS: dict[str, tuple[str, ...]] = {
    "sales": (
        ...
        "product", "catalogue", "catalog", "sku", "offer",
    ),
    "marketing": (
